...
You can also add files to your space when you add an [image block](insert-images.md) or an OpenAPI block. When you create one of these blocks, the Files panel will open, so you can either select a file, or upload a new file.
